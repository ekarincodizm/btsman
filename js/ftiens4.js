...
function Item(preClosure, itemDescription, postClosure, anchorClosure) // Constructor 
{ 
  // constant data 
  this.desc = itemDescription 
  this.preClosure = preClosure;
  this.postClosure = postClosure;
  this.anchorClosure = anchorClosure;
...
{ 
  ...
  if (USETEXTLINKS) 
    docW = docW + this.preClosure +"<a " + fullLink + " id=\"itemTextLink"+this.id+"\" " + this.anchorClosure +" >"+ this.desc+ "</a>" + this.postClosure
  else 
    docW = docW + this.desc
...
function gLnk(optionFlags, description, linkData, preClosure, postClosure, anchorClosure) 
{ 
  ...
  newItem = new Item(preClosure, description,postClosure,anchorClosure);
